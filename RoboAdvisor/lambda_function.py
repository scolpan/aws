    ...
    if age is not None:
        ...
        if (age >= 65 or age <= 0) :
            return build_validation_result(
                False,
                "age",
                "You should be younger than 65 and older than 0 to use this service, "
                "please enter a different age."
            )


    # Validate the investment amount, it should not be < 5000
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The amount to invest should not be less than 5000, "
...
def recommend_portfolio(intent_request):
    ...
    #Get the riskLevel intent (pressed button)
    if risk_level == "None":
